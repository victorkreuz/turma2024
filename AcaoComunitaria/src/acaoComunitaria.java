...
public class acaoComunitaria extends javax.swing.JFrame {
    ...
    /**
     * Creates new form acaoComunitaria
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (quantidadeDias < 3) {
            JOptionPane.showMessageDialog(null, "Você escolheu somente " + quantidadeDias + " dia(s)\n"
                    + "Deves escolher exatamente 3 dias.");
            return;
        }
        if (quantidadeDias > 3) {
            JOptionPane.showMessageDialog(null, "Você escolheu " + quantidadeDias + " dia(s)\n"
                    + "Deves escolher exatamente 3 dias.");
            return;
        }
        JOptionPane.showMessageDialog(null, "Você escolheu " + quantidadeDias + " dia(s)\n"
